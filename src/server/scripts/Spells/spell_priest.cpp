...
class spell_pri_spirit_of_redemption : public SpellScriptLoader
{
    public:
        ...
        class spell_pri_spirit_of_redemption_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                OnEffectApply  += AuraEffectApplyFn(spell_pri_spirit_of_redemption_AuraScript::HandleApplyEffect, EFFECT_1, SPELL_AURA_WATER_BREATHING, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                OnEffectRemove += AuraEffectRemoveFn(spell_pri_spirit_of_redemption_AuraScript::HandleRemoveEffect, EFFECT_1, SPELL_AURA_WATER_BREATHING, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
