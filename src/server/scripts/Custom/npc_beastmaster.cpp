...
void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
        ...
        if(player->GetPet()) {
            ...
            m_creature->MonsterWhisper("First you must dismiss your Pet!", player->GetGUID(), true);
            player->PlayerTalkClass->SendCloseGossip();
            return;
        }
        ...
        //end
        player->PlayerTalkClass->SendCloseGossip();
        m_creature->MonsterWhisper("Pet added. You might want to feed it and name it!", player->GetGUID());
        m_creature->MonsterWhisper("Pet added. You might want to feed it and name it!", player->GetGUID(), true);
    }
