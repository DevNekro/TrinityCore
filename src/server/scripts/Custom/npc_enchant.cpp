enum Enchants
{
    ...
    ENCHANT_WAIST_BELT_BUCKLE           = 55655,
};
...
void Enchant(Player* player, Item* item, uint32 enchantid)
{
    ...
    if (!enchantid)
    {
        ...
        sLog->outInfo(LOG_FILTER_GENERAL, "enchant_vendor::Enchant: Enchant NPC 'enchantid' is NULL, something went wrong here!");
        return;
    }
...
public:
    npc_enchantment() : CreatureScript("npc_enchantment") { }
        ...
        {
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Weapon_ShortBlade_02:24|t|r[Enchant Weapon]", GOSSIP_SENDER_MAIN, 1);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Weapon_Staff_109:24|t|r[Enchant 2H Weapon]", GOSSIP_SENDER_MAIN, 2);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\Ability_Warrior_ShieldWall:24|t|r[Enchant Shield]", GOSSIP_SENDER_MAIN, 3);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Head_Gnome_01:24|t|r[Enchant Head]", GOSSIP_SENDER_MAIN, 4);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_SHOULDER_97:24|t|r[Enchant Shoulders]", GOSSIP_SENDER_MAIN, 5);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\Item_icecrowncloak:24|t|r[Enchant Cloak]", GOSSIP_SENDER_MAIN, 6);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_ClothChest:24|t|r[Enchant Chest]", GOSSIP_SENDER_MAIN, 7);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_MailBracer:24|t|r[Enchant Bracers]", GOSSIP_SENDER_MAIN, 8);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_PlateGloves:24|t|r[Enchant Gloves]", GOSSIP_SENDER_MAIN, 9);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_ClothPants:24|t|r[Enchant Legs]", GOSSIP_SENDER_MAIN, 10);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_LeatherBoots:24|t|r[Enchant Feet]", GOSSIP_SENDER_MAIN, 11);
			player->ADD_GOSSIP_ITEM(1, "|cff00ff00|TInterface\\icons\\inv_misc_enchantedscroll:24|t|r[Eternal Belt Buckle]", GOSSIP_SENDER_MAIN, 206);
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            switch (action)
            {
                ...
                case 1: // Enchant Weapon
                    ...
                    player->ADD_GOSSIP_ITEM(1, "400 Attack Power Proc", GOSSIP_SENDER_MAIN, 104);
                    player->ADD_GOSSIP_ITEM(1, "25 Hit + 25 Crit", GOSSIP_SENDER_MAIN, 105);
                    player->ADD_GOSSIP_ITEM(1, "250 Spell Haste Proc", GOSSIP_SENDER_MAIN, 106);
                    player->ADD_GOSSIP_ITEM(1, "Chance of heal on hit", GOSSIP_SENDER_MAIN, 107);
                    player->ADD_GOSSIP_ITEM(1, "Fire damage on hit", GOSSIP_SENDER_MAIN, 108);
                    player->ADD_GOSSIP_ITEM(1, "Chance of heal on hit", GOSSIP_SENDER_MAIN, 109);
                    player->ADD_GOSSIP_ITEM(1, "50 Stam", GOSSIP_SENDER_MAIN, 110);
                    ...
                    player->ADD_GOSSIP_ITEM(1, "120 Agility Proc", GOSSIP_SENDER_MAIN, 113);
                    player->ADD_GOSSIP_ITEM(1, "120 Arm Pen Proc", GOSSIP_SENDER_MAIN, 114);
                ...
                case 3: // Enchant Shield
						...
						if (item->GetTemplate()->InventoryType == INVTYPE_SHIELD)
						{
							...
							player->ADD_GOSSIP_ITEM(1, "81 Block + 50% less Disarm", GOSSIP_SENDER_MAIN, 121);
							player->ADD_GOSSIP_ITEM(1, "18 Stamina", GOSSIP_SENDER_MAIN, 122);
							player->ADD_GOSSIP_ITEM(1, "36 Block", GOSSIP_SENDER_MAIN, 123);
							player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
						}
						else
						{
                ...
                case 4: // Enchant Head
                    ...
                    player->ADD_GOSSIP_ITEM(1, "29 Spell Power + 20 Resil", GOSSIP_SENDER_MAIN, 126);
                    player->ADD_GOSSIP_ITEM(1, "30 Stamina + 25 Resil", GOSSIP_SENDER_MAIN, 127);
                    player->ADD_GOSSIP_ITEM(1, "37 Stamina + Defense", GOSSIP_SENDER_MAIN, 128);
                    player->ADD_GOSSIP_ITEM(1, "50 Attack Power + 20 Crit", GOSSIP_SENDER_MAIN, 129);
                    player->ADD_GOSSIP_ITEM(1, "50 Attack Power + 20 Resil", GOSSIP_SENDER_MAIN, 130);
					player->ADD_GOSSIP_ITEM(1, "25 Arcane Resist + 30 Stam", GOSSIP_SENDER_MAIN, 131);
					player->ADD_GOSSIP_ITEM(1, "25 Fire Resist + 30 Stam", GOSSIP_SENDER_MAIN, 132);
					player->ADD_GOSSIP_ITEM(1, "25 Shadow Resist + 30 Stam", GOSSIP_SENDER_MAIN, 133);
					player->ADD_GOSSIP_ITEM(1, "25 Frost Resist + 30 Stam", GOSSIP_SENDER_MAIN, 134);
					player->ADD_GOSSIP_ITEM(1, "25 Nature Resist + 30 Stam", GOSSIP_SENDER_MAIN, 135);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 5: // Enchant Shoulders
                    ...
                    player->ADD_GOSSIP_ITEM(1, "30 Stamina + 15 Resil", GOSSIP_SENDER_MAIN, 142);
                    ...
                    player->ADD_GOSSIP_ITEM(1, "23 Spell Power + 15 Resil", GOSSIP_SENDER_MAIN, 145);
                    player->ADD_GOSSIP_ITEM(1, "40 Attack Power + 15 Resil", GOSSIP_SENDER_MAIN, 146);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
                ...
                case 6: // Enchant Cloak
				 if (player->HasSkill(SKILL_TAILORING) && player->GetSkillValue(SKILL_TAILORING) == 450)
				  ...
				  if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450)
				  {
                    ...
                    player->ADD_GOSSIP_ITEM(1, "+ Stealth + 10 Agil", GOSSIP_SENDER_MAIN, 148);                  
                    ...
                    player->ADD_GOSSIP_ITEM(1, "35 Spell Pen", GOSSIP_SENDER_MAIN, 154);
				...
				case 7: //Enchant chest
					player->ADD_GOSSIP_ITEM(1, "10 of all stats", GOSSIP_SENDER_MAIN, 158);
				 ...
				 if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450)
				   {
					...
					player->ADD_GOSSIP_ITEM(1, "4 Attack Power", GOSSIP_SENDER_MAIN, 180);
				...
				case 10: //Enchant legs
					player->ADD_GOSSIP_ITEM(1, "40 Resil 28 Stam", GOSSIP_SENDER_MAIN, 184);
					player->ADD_GOSSIP_ITEM(1, "55 Stam 22 Agil", GOSSIP_SENDER_MAIN, 185);
					player->ADD_GOSSIP_ITEM(1, "75 AP 22 Crit", GOSSIP_SENDER_MAIN, 186);
					player->ADD_GOSSIP_ITEM(1, "50 SP 22 Spirit", GOSSIP_SENDER_MAIN, 187);
					player->ADD_GOSSIP_ITEM(1, "50 SP 30 Stam", GOSSIP_SENDER_MAIN, 188);
					player->ADD_GOSSIP_ITEM(1, "72 Stam 35 Agil", GOSSIP_SENDER_MAIN, 189);
					player->ADD_GOSSIP_ITEM(1, "100 AP 36 Crit", GOSSIP_SENDER_MAIN, 190);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				...
				case 11: //Enchant feet
					player->ADD_GOSSIP_ITEM(1, "32 Assult", GOSSIP_SENDER_MAIN, 191);
					player->ADD_GOSSIP_ITEM(1, "15 Stam + Speed Increase", GOSSIP_SENDER_MAIN, 192);
					player->ADD_GOSSIP_ITEM(1, "16 Agility", GOSSIP_SENDER_MAIN, 193);
					player->ADD_GOSSIP_ITEM(1, "18 Spirit", GOSSIP_SENDER_MAIN, 194);
					player->ADD_GOSSIP_ITEM(1, "7 Mp5", GOSSIP_SENDER_MAIN, 195);
					player->ADD_GOSSIP_ITEM(1, "12 Hit + 12 Crit", GOSSIP_SENDER_MAIN, 196);
					player->ADD_GOSSIP_ITEM(1, "22 Stam", GOSSIP_SENDER_MAIN, 197);
					 if (player->HasSkill(SKILL_ENGINEERING) && player->GetSkillValue(SKILL_ENGINEERING) == 450)
				   {
                ...
                case 206:
					Enchant(player, player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_WAIST), ENCHANT_WAIST_BELT_BUCKLE);
                    player->PlayerTalkClass->SendCloseGossip();
                    break;
