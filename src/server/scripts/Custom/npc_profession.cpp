        ...
        public:
                ...
                { 
                        ...
                        if (uiSender == GOSSIP_SENDER_MAIN)
                        {
                                ...
                                {
                                        case 196:
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Alchemy:24|t|r500g - Alchemy", GOSSIP_SENDER_MAIN, 1);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Blacksmithing:24|t|r500g - Blacksmithing", GOSSIP_SENDER_MAIN, 2);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Leatherworking:24|t|r500g - Leatherworking", GOSSIP_SENDER_MAIN, 3);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Tailoring:24|t|r500g - Tailoring", GOSSIP_SENDER_MAIN, 4);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Engineering:24|t|r500g - Engineering", GOSSIP_SENDER_MAIN, 5);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Engraving:24|t|r500g - Enchanting", GOSSIP_SENDER_MAIN, 6);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_JEWELCRAFTING_GEM_31:24|t|r500g - Jewelcrafting", GOSSIP_SENDER_MAIN, 7);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Inscription_Tradeskill01:24|t|r500g - Inscription", GOSSIP_SENDER_MAIN, 8);
												pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Herbalism:24|t|r500g - Herbalism", GOSSIP_SENDER_MAIN, 11);
												pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_LeatherScrap_01:24|t|r500g - Skinning", GOSSIP_SENDER_MAIN, 12);
												pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Trade_Mining:24|t|r500g - Mining", GOSSIP_SENDER_MAIN, 13);
												pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Food_137_Meat:24|t|r200g - Cooking", GOSSIP_SENDER_MAIN, 9);
                                                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Bandage_Frostweave_Heavy.:24|t|r200g - First Aid", GOSSIP_SENDER_MAIN, 10);
                                        ...
                                        case 1:
												...
												pPlayer->SetMoney(pPlayer->GetMoney() -5000000);
												pPlayer->PlayerTalkClass->SendCloseGossip();
												}else
												{
												_creature->MonsterWhisper("You don't got enough gold!", pPlayer->GetGUID());
												pPlayer->PlayerTalkClass->SendCloseGossip();
												}break;
